...
def merge_bk_ex(bk_input_file_path,ex_input_file_path,output_file_path):
    js_merged = read_jsonl(bk_input_file_path)
    ...
    print(f"The merged file of bk and example has been saved into {output_file_path}")