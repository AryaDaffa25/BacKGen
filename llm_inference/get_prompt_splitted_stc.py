...
def get_prompt_spc_zero_with_explanation(text,target_phrase,prompt_variant=1):
...
def get_prompt_spc_few_with_explanation(text,target_phrase,negative_example_list,positive_example_list,prompt_variant=11):
...
def get_prompt_spc_bk_with_explanation(text,target_phrase,bk_list,prompt_variant=1):
