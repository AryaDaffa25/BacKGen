...
def get_prompt_pk_ablation(frame_list,text_list,frame_definition_list,polarity,prompt_variant=1):
    ...
    # Text
        ...
        raise ValueError(f"You choose variant {prompt_variant} but we do not have it in get_prompt_pk_ablation function. Please define your variant in that function.")